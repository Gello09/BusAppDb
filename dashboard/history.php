...
<head>
    ...
    <title>Dashboard - History Schedule</title>
</head>
    <body>
        <div class="dashboard-container">
            ...
            <div class="total-booking">
                ...
                <div class="total">
                    Total history of booking = 
                    <?php 
                        if($_SESSION['total-history'] != 0){
                            echo $_SESSION['total-history'];
                        }else {
                            $_SESSION['total-history'] = "0";
                            echo "0";
                        }
                    ?>
                </div>
                ...
                ?>
                    <div class="booking-schedule booking-section">
                        ...
                        <div class="sched-container">
                            <?php 
                                if($action === 'Confirm'){
                                    echo '<span class="confirm">'. $action .'</span>';
                                }else if($action === 'Decline'){
                                    echo '<span class="decline">'. $action .'</span>';
                                }else {
